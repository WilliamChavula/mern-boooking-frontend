        ...
        <div className='grid lg:grid-cols-[250px_1fr] gap-4 w-full'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                {searchResults.data.map(hotel => (
                    <Card
                        key={hotel._id}
                        className='rounded-none w-full shadow-none grid lg:grid-cols-[2fr_3fr] p-8 gap-5 border border-slate-300'
                    >
                        ...
                        <div className='flex flex-col justify-between'>
                            ...
                            <CardFooter className='hidden lg:grid grid-cols-2 items-end whitespace-nowrap'>
